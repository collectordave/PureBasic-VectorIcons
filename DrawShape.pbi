...
;       Description: Module to handle drawing of Shapes on main form canvas
; ====================================================
;.......10........20........30........40........50........60........70........80
;}

DeclareModule DrawShape
...
Procedure Process(x.i,y.i)
    ...
    Select DrawAction
      ...
      Case 1 ;Size
        ...
        Main::DrawShape(AppMain::NewObject)
        
      Case 2 ;Rotation
          
        VectorSourceColor(RGBA($00,$FF,$00,$FF))
          
        AddPathCircle(AppMain::NewObject\X1 * 5,AppMain::NewObject\Y1 * 5, (AppMain::NewObject\RadiusX/2) * 5 , 0,360)     
        StrokePath(1)   
              ...
              Case #PB_EventType_LeftClick
                ...
                Select Drawaction
                  ...
                  Case 1 ;Size
                    ...
                    AppMain::NewObject\RadiusX = AppMain::NewObject\RadiusX  * 2
                    Drawaction = Drawaction + 1
...
Procedure Defaults()
  ...
  AppMain::NewObject\Stroke = #False  
